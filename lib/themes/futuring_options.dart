...
import 'package:app/consts/global_settings.dart';
...
class FuturingOptions {
  const FuturingOptions({
    this.themeMode,
  ...
  static FuturingOptions of(BuildContext context) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
    return scope.modelBindingState.currentModel;
  }

  static void update(BuildContext context, FuturingOptions newModel) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
...
// Applies text FuturingOptions to a widget
class ApplyTextOptions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final options = FuturingOptions.of(context);
...
class ModelBinding extends StatefulWidget {
  ModelBinding({
    Key key,
    this.initialModel = const FuturingOptions(),
    this.child,
  })  : assert(initialModel != null),
        super(key: key);

  final FuturingOptions initialModel;
  final Widget child;
...
class _ModelBindingState extends State<ModelBinding> {
  ...
  void handleTimeDilation(FuturingOptions newModel) {
  ...
  void handleThemeChange(FuturingOptions newModel) {
  ...
  void updateModel(FuturingOptions newModel) {
