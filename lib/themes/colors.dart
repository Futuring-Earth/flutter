...
/// Most color assignments in the pieChart are not like the the typical color
...
class CheckinColors {
  static const List<Color> teams = <Color>[
    Color(0xFF005D57),
    Color(0xFF04B97F),
    Color(0xFF37EFBA),
    Color(0xFF007D51),
  ...
  static const List<Color> otherChart = <Color>[
    Color(0xFFFFDC78),
    Color(0xFFFF6951),
    Color(0xFFFFD7D0),
    Color(0xFFFFAC12),
  ...
  static Color teamColor(int i) {
    return cycledColor(teams, i);
  }

  /// Convenience method to get a single budget color with position i.
  static Color otherChartColor(int i) {
    return cycledColor(otherChart, i);
  }
